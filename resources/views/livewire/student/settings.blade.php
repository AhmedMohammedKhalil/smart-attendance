                ...
                <form wire:submit.prevent='edit'>
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>المستوى</label>
                                <select class="form-control" name="level" wire:model='level'>
                                    <option value="">اختر المستوى</option>
                                    <option value="الأول" @if($level=="الأول" ) selected @endif>الأول</option>
                                    <option value="الثانى" @if($level=="الثانى" ) selected @endif>الثانى</option>
                                    <option value="الثالث" @if($level=="الثالث" ) selected @endif>الثالث</option>
                                    <option value="الرابع" @if($level=="الرابع" ) selected @endif>الرابع</option>
                                </select>
